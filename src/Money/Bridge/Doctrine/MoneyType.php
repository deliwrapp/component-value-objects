...
namespace Deliwrapp\Component\ValueObjects\Money\Bridge\Doctrine;
...
final class MoneyType extends Type
{
    ...
    public function convertToDatabaseValue($value, AbstractPlatform $platform): ?string
    {
        ...
        if ( ! $value instanceof Money) {
            ...
            throw new \InvalidArgumentException(sprintf('You have to pass an object of kind \Deliwrapp\Component\ValueObjects\Money\Money to use the Doctrine type MoneyType. "%s" passed instead.', $type));
        }
